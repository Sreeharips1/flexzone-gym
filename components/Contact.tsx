...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:enquiries@flexzonegym.com?subject=Contact%20Form%20Submission&body=
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-black bg-opacity-90 animate-fadeIn"></div>
      
      <div className="max-w-6xl mx-auto relative z-10">
        <motion.h2 className="text-3xl font-bold text-center mb-12" initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          Book Free Trial
        </motion.h2>

        <div className="grid md:grid-cols-2 gap-12">
          <motion.div className="bg-gray-1000 p-8 rounded-lg shadow-lg" initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }}>
            <h3 className="text-xl font-semibold mb-4">Send us a message</h3>
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <MotionTextarea
                ...
                whileFocus={{ scale: 1.05 }}
              />
              <motion.button type="submit" className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-3 rounded-lg transition duration-300" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                Send Message
              </motion.button>
            </form>
          </motion.div>

          <motion.div className="relative bg-cover bg-center rounded-lg overflow-hidden shadow-lg p-8" style={{ backgroundImage: "url('/assets/img/gym-bg1.png')" }} initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.4 }}>
            <div className="absolute inset-0 bg-black bg-opacity-60"></div>
            <div className="relative z-10">
              <div className="space-y-5">
                {[
